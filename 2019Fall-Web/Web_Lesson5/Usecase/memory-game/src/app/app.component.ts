  ...
  constructor() {
    ...
    for (var i = 0; i < this.amountOfCards; i++) {
      this.cards.push({
        ...
        answer: 'cloud',
        border: 'fa-border',
        imagesrc: '../assets/images/questionmark.png',
        imageAnswersrc: '../assets/images/questionmark.png'
      });
    }

    //Add pairs
    this.addPair('../assets/images/umbrella.png');
    this.addPair('../assets/images/tiger.png');
    this.addPair('../assets/images/car.png');
    this.addPair('../assets/images/ballon.png');
  }

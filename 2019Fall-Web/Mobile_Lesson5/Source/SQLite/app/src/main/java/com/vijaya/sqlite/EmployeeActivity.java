...
public class EmployeeActivity extends AppCompatActivity {
    ...
    private void saveToDB() {
        ...
        Toast.makeText(this, "New row created, Row ID: " + newRowId, Toast.LENGTH_LONG).show();
    }
    ...
    private void updateDB(){
        ...
        String selection = SampleDBContract.Employee.COLUMN_FIRSTNAME + " like ?";
        String[] projection = {SampleDBContract.Employee._ID,
        ...
        if(cursor.getCount() > 0){
            cursor.moveToNext();
            String employee_id = cursor.getString(cursor.getColumnIndex(SampleDBContract.Employee._ID));

            database.update(SampleDBContract.Employee.TABLE_NAME, values, SampleDBContract.Employee._ID + "=?", new String[]{employee_id});
        }

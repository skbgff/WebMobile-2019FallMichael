...
public class SummarActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_summar);
    ...
    public void goToOrder (View view){
        Intent goOrderIntent = new Intent(SummarActivity.this,MainActivity.class);
